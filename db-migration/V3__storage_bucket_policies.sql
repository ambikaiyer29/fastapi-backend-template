...
-- 2. Create policies for the 'tenant-assets' bucket
--    We drop existing policies to ensure this script is the source of truth.
DROP POLICY IF EXISTS "tenant_select_policy" ON storage.objects;
DROP POLICY IF EXISTS "tenant_insert_policy" ON storage.objects;
